...
//main constractor
  ...
  Future<void> googleSignIn() async {
    try {
      ...
      if (await userServices.isSignedInBefore(
          userId: googleSignInAccount1!.id)) {
      ...
      Fluttertoast.showToast(
          msg: "sign in With Google Failed, " + e.message.toString(),
  ...
  Future<void> googleSignUp(
    ...
    try {
      ...
      Fluttertoast.showToast(
          msg: "sign up With Google Failed, " + e.message.toString(),
          toastLength: Toast.LENGTH_LONG);
      authPage = AuthPage.GOOGLE_SIGN_UP;
      notifyListeners();
    }
  ...
  Future<void> signInAndUpWithEmail(
    ...
    try {
      ...
      Fluttertoast.showToast(
          msg: "Sign up Failed, " + e.message.toString(),
          toastLength: Toast.LENGTH_LONG);
      notifyListeners();
    }
  }
