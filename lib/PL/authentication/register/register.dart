...
class RegisterPage extends StatelessWidget {
  ...
  onPressSignUp(BuildContext context) async {
    ...
    if (userChange!.profileImage==null||CustomBirthdateState.selectedBirthDate == "") {
      showDialog(
          context: context,
          builder: (c) {
            return ErrorDialog(
    ...
    {
      await userChange!.signInAndUpWithEmail(type: "sign up",
    ...
    return Align(
      ...
      child: Container(
        ...
        Icon(Icons.arrow_back,color: Colors.white,)
          ,onPressed: ()=> userChange!.setAuthPage(AuthPage.SIGN_IN)
        ,),
