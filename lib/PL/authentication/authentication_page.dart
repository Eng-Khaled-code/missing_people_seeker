...
class AuthenticationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color backColor=Theme.of(context).colorScheme.background==Colors.white?LightColors.startsBackground:DarkColors.startsBackground;

    return
      userChange.authPage==AuthPage.HOME
        ?
    HomePage()
        :
    Scaffold(
   ...
   Widget body({UserChange? userChange,BuildContext? context}){
     ...
     String text=page==AuthPage.SIGN_IN?Strings.logIn:page==AuthPage.GOOGLE_SIGN_UP?Strings.googleSignUp:Strings.emailSignUp;
